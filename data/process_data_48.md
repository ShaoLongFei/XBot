...
**客户**：对公打款时备注信息里面忘记填写充值账户
**客户**：对公打款时备注信息里面忘记填写充值账户[图片]
...
**客户**：通过 接口调用 accessKey 从哪里可以获取到
**客服**：您好，这里获取哈：[REDACTED_URL]
**客户**：好的谢谢
**客服**：不客气的，您这边还有其他问题吗
**客户**：在api 这个bucket 是传递什么名称 是只cdn 那块参数 [图片]
**客服**：您好，bucket是您存储空间的名称
**客户**：api 上传成功之后 但是这边没有查询到 [图片]
**客户**：api 上传会有延迟吗？
**客户**：无法上传 图片
**客户**：/mmm/1101/00525225.mp4FnzozAFsDLbdfxJgTEuCbBJITTni
**客户**：这是上传结果
**客服**：您好，上传需要上传时间，收到返回结果就是上传成功了。/mmm/1101/00525225.mp4是空间中保存的文件名FnzozAFsDLbdfxJgTEuCbBJITTni是文件hash
**客户**：现在看到了 这个有点延迟
**客户**：大概延迟 3-5分钟  ok
**客服**：嗯嗯好的
...
您的订单编号：${code}。物流信息：SF123465已经出货，编辑完短信点完成提示“未知错误”

### 客服解答

**客户**：您的订单编号：${code}。物流信息：SF123465已经出货，编辑完短信点完成提示“未知错误”
**客服**：您好，您这边F12一下看下报错请求的响应信息是什么的
